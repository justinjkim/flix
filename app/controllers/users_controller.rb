class UsersController < ApplicationController
  ...
  def destroy
    @user = User.find_by!(username: params[:id]) # need this line, since "before_action :require_correct_user" doesn't run for this anymore
    @user.destroy
  ...
  def require_correct_user
    @user = User.find_by!(username: params[:id]) # this @user gets called for [:edit, :update] actions
